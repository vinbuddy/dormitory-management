...
#### Hướng dẫn sử dụng
_ Trang thanh toán : invoice
 _ 1. Lựa chọn phòng muốn thanh toán
 _ 2. Chọn thanh toán cho( tiền phòng, tiền điện nước, tiền thuê thiết bị), nếu là tiền phòng,chọn thêm sinh viên.
 _ 3. Xem thông tin hoá đơn và thanh toán hoặc cancel.(nếu không có hiện không có gì để thanh toán).
